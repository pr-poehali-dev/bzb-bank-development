        ...
        <div className="flex items-center">
          <div className="flex items-center mr-2">
            <div className="logo-container relative">
              <div className="logo-shield text-primary-dark font-heading font-bold text-2xl relative">
                БЗР
                {/* Стилизованный элемент щита вокруг логотипа */}
                <div className="absolute -inset-2 border-2 border-primary/40 rounded-lg -z-10"></div>
                <div className="absolute -inset-1 border border-primary-dark/30 rounded-md -z-10"></div>
              </div>
              <div className="w-2 h-2 rounded-full bg-primary-light mx-1 animate-pulse-light"></div>
              <div className="text-primary font-heading font-semibold text-lg relative">
                БАНК
