        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 z-10">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-lg">
              БЗР Банк специализируется на работе с организациями, выполняющими
              государственные оборонные заказы, предлагая надежные финансовые
              решения и выгодные условия для всех клиентов.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 mt-12">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Государственная гарантия надежности
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Специализация на гособоронзаказе
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Оперативное решение финансовых вопросов
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="order-1 lg:order-2 relative flex justify-center">
            <div className="relative z-10 w-full max-w-md">
              ...
              <div className="absolute -bottom-6 -left-6 bg-primary p-4 rounded-lg shadow-lg text-white flex items-center space-x-3 z-20 animate-fade-in">
              ...
              <div className="absolute -top-6 -right-6 bg-white p-4 rounded-lg shadow-lg flex items-center space-x-3 z-20 animate-fade-in">
