...
const QrCodeSection = () => {
  ...
  const qrCodeUrl =
    "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://bzr-bank.ru";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-primary text-white p-8 md:p-12">
              ...
              <p className="opacity-90 mb-8">
                Скачайте наше мобильное приложение или отсканируйте QR-код для
                быстрого доступа ко всем услугам банка. Управляйте своими
                финансами в любое время и в любом месте.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-80">
                      Доступ к счетам и операциям 24/7
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-80">
                      Защищенный доступ к личному кабинету
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-80">
                      Мгновенные оповещения о транзакциях
                    </p>
                  </div>
                </div>
              </div>
