...
const testimonials = [
  {
    ...
    content:
      "БЗР Банк предоставил нам оптимальное решение для работы с гособоронзаказом. Профессиональная команда, учитывающая все нюансы законодательства и специфику нашей деятельности. Особенно ценим оперативность принятия решений и качество обслуживания.",
    rating: 5,
  },
  {
    id: 2,
    ...
    content:
      "Сотрудничаем с БЗР Банком более 5 лет. За это время банк зарекомендовал себя как надежный партнер в финансовой сфере. Нам особенно нравится индивидуальный подход к клиентам и понимание специфики работы предприятий оборонно-промышленного комплекса.",
    rating: 5,
  },
  {
    id: 3,
    ...
    content:
      "Изначально привлекли выгодные условия кредитования для малого бизнеса. После года работы могу с уверенностью сказать, что БЗР Банк предлагает действительно конкурентные условия и отличный сервис. Отдельная благодарность за оперативное решение всех вопросов.",
    rating: 4,
  },
  {
    id: 4,
    ...
    content:
      "БЗР Банк предоставляет максимально комфортные условия для работы с гособоронзаказом. Отличная команда специалистов, которые помогают в решении даже самых сложных вопросов. Рекомендую данный банк всем предприятиям, работающим по ГОЗ.",
    rating: 5,
  },
  {
    id: 5,
    ...
    content:
      "Пользуюсь услугами БЗР Банка для личных финансов уже больше 3 лет. Очень доволен условиями по вкладам и дебетовой карте. Отдельно хочу отметить удобное мобильное приложение и отзывчивую службу поддержки, которая всегда оперативно решает все вопросы.",
    rating: 5,
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Мнение клиентов — главный показатель качества нашей работы. Мы
            гордимся доверием, которое нам оказывают предприятия
            оборонно-промышленного комплекса и частные клиенты.
          </p>
        </div>
          ...
          >
            <CarouselContent>
              {testimonials.map((testimonial) => (
                ...
                >
                  <div className="h-full bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow hover:-translate-y-1 duration-300">
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={index} className="text-center animate-fade-in">
              ...
              <h3 className="text-3xl font-bold text-primary-dark mb-1">
                {stat.number}
              </h3>
